...
- `docs/samples/claude-rate-limits/` — launchd-scheduled script that shows how much of your Claude subscription's 5-hour and 7-day rate-limit windows is left.
